...
const DB_CONNECTION_STRING = 'mongodb://localhost:27017/pathshala';
const SCHOOL_API_URL = 'http://localhost:3005/pathshala/api/v1/internal/school/create';
const SIGNUP_API_URL = `${services.pramaan_external}/auth/signup`;
const LOGIN_API_URL = `${services.pramaan_external}/auth/login`;
