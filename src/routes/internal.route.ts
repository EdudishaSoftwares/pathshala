...
// Validators
import { createSchoolSchema, getSchoolDetailsQuerySchema } from '@/controllers/validators/school.controller.validation';
// Utils
...
class ExternalRoute implements Routes {
  ...
  private initializeSchoolRoutes(prefix: string) {
    ...
    this.router.get(
      ...
      this.validatorMiddleware.validateRequestQuery(getSchoolDetailsQuerySchema),
